function loadEducationalAttractions() {
    fetch('xml/attractions.xml')
        ...
        .then(str => {
            ...
            const educationalList = document.getElementById("educational-list");
            ...
            Array.from(attractions).forEach(attraction => {
                ...
                if (category === "Educational") {
                    ...
                    div.innerHTML = `
                        ...
                        <p><strong>State:</strong> ${location}</p>
                    ...
                    educationalList.appendChild(div);
                }
            });
        })
...
window.onload = loadEducationalAttractions;
