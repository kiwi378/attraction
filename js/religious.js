function loadReligiousAttractions() {
    fetch('xml/attractions.xml')
        ...
        .then(str => {
            ...
            const religiousList = document.getElementById("religious-list");
...
window.onload = loadReligiousAttractions;
